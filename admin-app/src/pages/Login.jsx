    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Reelz Admin</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Sign in with your admin account</p>
        </div>
